...
from RatS.inserters.metacritic_inserter import MetacriticRatingsInserter
...
class MetacriticRatingsInserterTest(TestCase):
    ...
    @patch('RatS.inserters.metacritic_inserter.MetacriticRatingsInserter._is_requested_movie')
    @patch('RatS.inserters.metacritic_inserter.MetacriticRatingsInserter._get_search_results')
    @patch('RatS.inserters.metacritic_inserter.Metacritic')
    @patch('RatS.inserters.base_inserter.Inserter.__init__')
    @patch('RatS.sites.base_site.Firefox')
