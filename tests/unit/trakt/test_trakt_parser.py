...
class TraktParserTest(TestCase):
    ...
    def setUp(self):
        with open(os.path.join(TESTDATA_PATH, 'my_ratings', 'trakt.html'), encoding='UTF-8') as my_ratings:
    ...
    @patch('RatS.base.base_parser.Parser.print_progress')
    @patch('RatS.trakt.trakt_parser.TraktRatingsParser.parse_movie_details_page')
    @patch('RatS.base.base_site.Firefox')
    @patch('RatS.base.base_parser.Parser.__init__')
    @patch('RatS.trakt.trakt_parser.Trakt')
