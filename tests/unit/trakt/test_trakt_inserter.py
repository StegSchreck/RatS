...
class TraktRatingsInserterTest(TestCase):
    ...
    @patch('RatS.trakt.trakt_inserter.TraktRatingsInserter._is_requested_movie')
    @patch('RatS.trakt.trakt_inserter.TraktRatingsInserter._get_search_results')
    @patch('RatS.trakt.trakt_inserter.Trakt')
    @patch('RatS.base.base_inserter.Inserter.__init__')
    @patch('RatS.base.base_site.Firefox')
    ...
    @patch('RatS.trakt.trakt_inserter.TraktRatingsInserter._compare_external_links')
    @patch('RatS.trakt.trakt_inserter.Trakt')
    @patch('RatS.base.base_inserter.Inserter.__init__')
    @patch('RatS.base.base_site.Firefox')
