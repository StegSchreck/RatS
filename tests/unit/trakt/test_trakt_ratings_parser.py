...
class TraktRatingsParserTest(TestCase):
    def setUp(self):
        ...
        with open(
            os.path.join(TESTDATA_PATH, "trakt", "movie_details_page_missing_imdb_id.html"),
            encoding="UTF-8",
    ...
    def test_parser_single_movie(self, site_mock, base_init_mock, browser_mock):
        ...
        self.assertEqual("https://www.imdb.com/title/tt0137523", movie.site_data[Site.IMDB].url)
    ...
    def test_parser_single_movie_with_missing_imdb_id(self, site_mock, base_init_mock, browser_mock):
        ...
        self.assertEqual("https://www.themoviedb.org/movie/314390", movie.site_data[Site.TMDB].url)
