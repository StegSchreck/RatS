...
class TMDBParserTest(TestCase):
    ...
    def setUp(self):
        with open(os.path.join(TESTDATA_PATH, 'my_ratings', 'tmdb.html'), encoding='UTF-8') as my_ratings:
    ...
    @patch('RatS.tmdb.tmdb_parser.TMDBRatingsParser.parse_movie_details_page')
    @patch('RatS.base.base_site.Firefox')
    @patch('RatS.base.base_parser.Parser.__init__')
    @patch('RatS.tmdb.tmdb_parser.TMDB')
