...
class MovielensParserTest(TestCase):
    ...
    @patch('RatS.movielens.movielens_parser.MovielensRatingsParser._parse_movies_from_csv')
    @patch('RatS.movielens.movielens_parser.MovielensRatingsParser._rename_csv_file')
    @patch('RatS.base.base_site.Firefox')
    @patch('RatS.base.base_parser.Parser.__init__')
    @patch('RatS.movielens.movielens_parser.Movielens')
