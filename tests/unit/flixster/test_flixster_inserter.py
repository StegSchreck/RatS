...
class FlixsterRatingsInserterTest(TestCase):
    ...
    @patch('RatS.flixster.flixster_inserter.FlixsterRatingsInserter._is_requested_movie')
    @patch('RatS.flixster.flixster_inserter.FlixsterRatingsInserter._get_search_results')
    @patch('RatS.flixster.flixster_inserter.Flixster')
    @patch('RatS.base.base_inserter.Inserter.__init__')
    @patch('RatS.base.base_site.Firefox')
    ...
    @patch('RatS.flixster.flixster_inserter.FlixsterRatingsInserter._search_for_movie')
    @patch('RatS.flixster.flixster_inserter.Flixster')
    @patch('RatS.base.base_inserter.Inserter.__init__')
    @patch('RatS.base.base_site.Firefox')
    ...
    @patch('RatS.flixster.flixster_inserter.FlixsterRatingsInserter._is_empty_search_result')
    @patch('RatS.flixster.flixster_inserter.FlixsterRatingsInserter._search_for_movie')
    @patch('RatS.flixster.flixster_inserter.Flixster')
    @patch('RatS.base.base_inserter.Inserter.__init__')
    @patch('RatS.base.base_site.Firefox')
