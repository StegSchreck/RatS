...
class MetacriticRatingsInserterTest(TestCase):
    ...
    @patch('RatS.metacritic.metacritic_inserter.MetacriticRatingsInserter._is_requested_movie')
    @patch('RatS.metacritic.metacritic_inserter.MetacriticRatingsInserter._get_search_results')
    @patch('RatS.metacritic.metacritic_inserter.Metacritic')
    @patch('RatS.base.base_inserter.Inserter.__init__')
    @patch('RatS.base.base_site.Firefox')
