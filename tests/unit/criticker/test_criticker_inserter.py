...
class CritickerRatingsInserterTest(TestCase):
    ...
    @patch('RatS.criticker.criticker_inserter.CritickerRatingsInserter._is_requested_movie')
    @patch('RatS.criticker.criticker_inserter.CritickerRatingsInserter._get_search_results')
    @patch('RatS.criticker.criticker_inserter.Criticker')
    @patch('RatS.base.base_inserter.Inserter.__init__')
    @patch('RatS.base.base_site.Firefox')
    ...
    @patch('RatS.criticker.criticker_inserter.CritickerRatingsInserter._compare_external_links')
    @patch('RatS.criticker.criticker_inserter.Criticker')
    @patch('RatS.base.base_inserter.Inserter.__init__')
    @patch('RatS.base.base_site.Firefox')
