...
class LetterboxdParserTest(TestCase):
    ...
    @patch('RatS.base.base_parser.Parser.__init__')
    ...
    @patch('RatS.letterboxd.letterboxd_parser.LetterboxdRatingsParser._get_downloaded_filename')
    @patch('RatS.letterboxd.letterboxd_parser.LetterboxdRatingsParser._parse_movies_from_csv')
    @patch('RatS.letterboxd.letterboxd_parser.LetterboxdRatingsParser._rename_csv_file')
    @patch('RatS.base.base_site.Firefox')
    @patch('RatS.base.base_parser.Parser.__init__')
    @patch('RatS.letterboxd.letterboxd_parser.Letterboxd')
