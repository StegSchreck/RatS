...
class LetterboxdRatingsInserterTest(TestCase):
    ...
    @patch('RatS.letterboxd.letterboxd_inserter.LetterboxdRatingsInserter._wait_for_import_processing')
    @patch('RatS.letterboxd.letterboxd_inserter.LetterboxdRatingsInserter._wait_for_movie_matching')
    @patch('RatS.letterboxd.letterboxd_inserter.save_movies_to_csv')
    @patch('RatS.letterboxd.letterboxd_inserter.Letterboxd')
    @patch('RatS.base.base_inserter.Inserter.__init__')
    @patch('RatS.base.base_site.Firefox')
