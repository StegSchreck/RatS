...
class AlloCine(BaseSite):
    ...
    def _get_ratings_url(self):
        account_link = self.browser.find_element(By.CSS_SELECTOR, "a.icon-profil").get_attribute("href")
        self.USER_ID = account_link.replace("https://www.allocine.fr/", "").split("/")[0]
    ...
    def handle_privacy_notice_if_present(self):
        ...
        if cookie_notice is not None:
            cookie_accept_button = cookie_notice.find_elements(By.CLASS_NAME, "qc-cmp-button")
