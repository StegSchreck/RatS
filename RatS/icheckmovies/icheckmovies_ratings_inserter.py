...
class ICheckMoviesRatingsInserter(RatingsUploader):
    def __init__(self, args):
        ...
        self.xpath_selector_for_submit_button = "//form//button[@type='submit'][@id='importVotes']"
    ...
    def upload_csv_file(self):
        ...
        time.sleep(1)
        favorite_criterium_select = Select(self.site.browser.find_element(By.ID, "importFavoriteCriterium"))
        favorite_criterium_select.select_by_value(self.site.INSERT_LIKE_LOWER_BOUND)
        time.sleep(1)
        hated_criterium_select = Select(self.site.browser.find_element(By.ID, "importHatedCriterium"))
