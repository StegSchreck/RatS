...
class CritickerRatingsInserter(RatingsInserter):
    ...
    def _search_for_movie(self, movie):
        search_url = 'https://www.criticker.com/?{search_params}&type=films'.format(
    ...
    def _post_movie_rating(self, my_rating):
        ...
        try:
            score = self.site.browser.find_element_by_id('fi_scoring_div').find_element_by_class_name('rating')
